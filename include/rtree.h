...
// https://github.com/tidwall/rtree.c/blob/master/rtree.h, license is also there
...
bool rtree_insert(struct rtree *tr, const uint64_t *min, const uint64_t *max, const void *data);
...
void rtree_search(const struct rtree *tr, const uint64_t *min, const uint64_t *max,
    bool (*iter)(const uint64_t *min, const uint64_t *max, const void *data, void *udata),
    void *udata);
...
//
// Returns false if the system is out of memory.
bool rtree_delete(struct rtree *tr, const uint64_t *min, const uint64_t *max, const void *data);
...
//
// Returns false if the system is out of memory.
bool rtree_delete_with_comparator(struct rtree *tr, const uint64_t *min,
    const uint64_t *max, const void *data,
